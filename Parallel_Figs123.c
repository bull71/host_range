// Parallel_Figs123.c to go with Bull, Wichman, Krone
...
S = (Paa+ Paai+ Pab+ Pabi+ Pbb+ Pbbi+ Pba+ Pbai+ Pga+ Pgai+ Pgb+ Pgbi);

S/= 1000.0;
// this dilution knocks total density back to 1000 in each culture
